    ...
    <div class="container">
        <div class="container-fluid d-flex align-items-center">
            <a class="navbar-brand fw-bold" href="/">
                <img src="{{ asset('home-resource/img/logobed.png') }}" alt="Logo" width="100%" height="30px" class="d-inline-block align-text-top">
            </a>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="nav ml-auto navbar-nav flex-grow-1 pe-3 me-auto">
                        ...
                        <li class="nav-item flex-column ">
                            <a class="nav-link mt-auto align-text-top text-light" href="/ticykit" aria-expanded="page">
                                TicyKit
                            </a>
                        </li>
